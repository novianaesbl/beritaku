                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Judul Artikel</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="judul" placeholder="Input Judul Artikel">
                                        </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <!-- <div class="form-group col-sm-10">
                                        <input type="text" class="form-control" id="exampleFormControlTextarea1" rows="5" name="isi"></textarea>
                                    </div> -->
                                </div>
                                        ...
                                        <?php
                                            ...
                                            foreach ($data_artikel as $row)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=$row->isi;?></td>
                                                    <td>
                                                        <a href="<?=base_url('berita/ubah_data_artikel/'); ?><?=$row->id_artikel; ?> " class="btn btn-success"  onclick="return confirm('Data ini akan diubah?') ">EDIT</a>
                                                        <a href="<?=base_url('berita/hapus_data_artikel/'); ?><?=$row->id_artikel; ?> " class="btn btn-danger"  onclick="return confirm('yakin dihapus !?') ">DELETE</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $no++;
